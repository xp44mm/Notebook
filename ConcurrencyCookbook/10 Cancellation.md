...
Alternatively, it’s possible to observe the CancellationToken directly in your
loop body:
...
Taking the first element is very similar; just modify the observable before
calling ToTask:
...
Asynchronously converting the entire observable sequence to a task is likewise
similar:
