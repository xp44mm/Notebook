...
Formally, we say LR(1) item \[$A \to \alpha\cdot\beta$, a\] is valid for a viable prefix $\gamma$  if there is a derivation $S \underset{lm}{\overset * \implies} \delta Aw  \underset{rm}\implies \delta \alpha \beta w$, where
